...
-- ── Vendor Verification ───────────────────────────────────────────────────────
-- Sensitive identity and registration details are intentionally isolated from
-- the publicly readable profiles table. Only service-role API routes access
-- this table; buyers see only profiles.seller_type + verification_status.
