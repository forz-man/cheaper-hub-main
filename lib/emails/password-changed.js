...
export function renderPasswordChangedEmail({ email, changedAt, resetPasswordUrl }) {
  return `
<!DOCTYPE html>
<html>
...
export async function sendPasswordChangedEmail({ email, changedAt, resetPasswordUrl }) {
  return resend.emails.send({
    from: EMAIL_FROM,
    to: email,
    subject: "Your Cheaper password was changed",
    html: renderPasswordChangedEmail({ email, changedAt, resetPasswordUrl }),
  });
}
